...
no_release_IncT1([H|T], T1, T2) :- sup(H, Hsup), Hsup .<. T1, no_release_IncT1(T, T1, T2).
no_release_IncT1([H|T], T1, T2) :- inf(H, Hinf), Hinf .>=. T2, no_release_IncT1(T, T1, T2).
...
no_terminate_IncT1([H|T], T1, T2) :- sup(H, Hsup), Hsup .<. T1, no_terminate_IncT1(T, T1, T2).
no_terminate_IncT1([H|T], T1, T2) :- inf(H, Hinf), Hinf .>=. T2, no_terminate_IncT1(T, T1, T2).
...
no_initiate_IncT1([H|T], T1, T2) :- sup(H, Hsup), Hsup .<. T1, no_initiate_IncT1(T, T1, T2).
no_initiate_IncT1([H|T], T1, T2) :- inf(H, Hinf), Hinf .>=. T2, no_initiate_IncT1(T, T1, T2).
